 ...
 * @author ACER
 */
public final class Fmr_MostrarListadoProductos1 extends javax.swing.JFrame {

    conexion conn = new conexion();
    Connection iniciarConexion = conn.conexion();

    public Fmr_MostrarListadoProductos1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fmr_MostrarListadoProductos1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fmr_MostrarListadoProductos1().setVisible(true);
            }
        });
    }
