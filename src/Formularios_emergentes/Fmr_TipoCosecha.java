...
public class Fmr_TipoCosecha extends javax.swing.JDialog {

    conexion objConexion = new conexion();
    Connection con = objConexion.conexion();
    private ComunicationPopUp comu;
    
    public Fmr_TipoCosecha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void Guardar() {
        ...
        if (txt_nombreTipoCosecha.getText().equals("")) {
            ...
            try {
                PreparedStatement guardar = con.prepareStatement("INSERT INTO Tipo_Cosecha (IDTipoCosecha, TipoCosecha, Nombre_TipoCosecha) VALUES (?,?,?)");
                guardar.setString(1, null);
                guardar.setString(2, txt_nombreTipoCosecha.getText());
                guardar.setString(3, txt_nombreTipoCosecha.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Fmr_TipoCosecha dialog = new Fmr_TipoCosecha(new javax.swing.JFrame(), true);
