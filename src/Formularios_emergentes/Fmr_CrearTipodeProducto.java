...
public class Fmr_CrearTipodeProducto extends javax.swing.JDialog {

    conexion conn = new conexion();
    Connection iniciarConexion = conn.conexion();
    
    public Fmr_CrearTipodeProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(txt_CrearTipodeProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 250, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Fmr_CrearTipodeProducto dialog = new Fmr_CrearTipodeProducto(new javax.swing.JFrame(), true);
